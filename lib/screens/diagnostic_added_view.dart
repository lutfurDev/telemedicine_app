...
class DiagnosticListAddedViewScreen extends StatelessWidget {
  const DiagnosticListAddedViewScreen({super.key});
          ...
          child: SizedBox(
            ...
            child: Card(
              ...
              child: Column(
                children: [
                  const Spacer(),
                  _addMoreToolsBtnLayout(context),
...
SliverAppBar sliverAppBar(context) {
  return SliverAppBar(
    expandedHeight: AppLayout.getHeight(22),
    elevation: 0,
    leading: IconButton(
      onPressed: () => Get.back(),
...
class SearchDoctorLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      expandedHeight: AppLayout.getWidth(50),
      elevation: 0,
      leading: Row(
        children: [
...
_doctorsLayout(BuildContext context) {
  return Column(
    ...
    children: [
      ...
      customSpacerHeight(height: 246)
    ],
  );
}

_addMoreToolsBtnLayout(BuildContext context) {
